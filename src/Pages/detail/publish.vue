      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="onParamsChange('trade', $event)"></v-chooser> 
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="onParamsChange('version', $event)"></v-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
export default {
  components: { vChooser, vCounter, myDialog, bankChooser, checkOrder },
  data() {
    return {
      trade: {},
      version: {},
  ...
  methods: {
    ...
    getPrice() {
      this.salePrice = this.trade.value * this.version.price * this.count;
    },
    onParamsChange(attr, val) {
      this[attr] = val;
      this.getPrice();
